...
STR_ANNOUNCE = "Find a path that spells a word in the following grid! Diagonals are permitted but each square" \
...
class RoundGenerator(object):
    ...
    def generate(self, randword, words, difficulty):
        ...
        return lambda x: x in validwords, [STR_ANNOUNCE] + self.format_grid(self.grid), set(alphabet)
